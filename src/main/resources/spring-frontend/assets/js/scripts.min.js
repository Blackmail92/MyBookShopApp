        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' +
                    '       <a class="Card-picture" href="' + '/book/' + book.slug + '">' +
                    '           <img src="' + book.image + '">\n' +
          ...
          (book.status === 'KEPT' ? '<a class="Card-status" title="Отложена"><img src="/assets/img/icons/heart.svg" alt="Отложена"></a>\n' : '') +
                    ...
                    '            <div class="Card-cost">' +
                    (book.discount > 0 ?
                    '            <span class="Card-priceOld">' + book.price + '</span>\n' +
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/postponed/changeBookStatus/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                            ...
                            Login().postData('/cart/changeBookStatus/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
